...
namespace Morph.Julian
{
    ...
    public class PlayerControllerOld : MonoBehaviour
    {
        ...
        [Header("Movement")]
        [SerializeField] private PlayerSettingsOld m_blobMovementSettings;
        [SerializeField] private PlayerSettingsOld m_birdMovementSettings;
        ...
        private Dictionary<PlayerType,PlayerSettingsOld> m_playerSettings = new Dictionary<PlayerType, PlayerSettingsOld>();
        private PlayerType m_activePlayerType;
        private enum PlayerType{ blob = 0, bird = 1 }
        private PlayerSettingsOld Settings { get => m_playerSettings[m_activePlayerType]; }
